<?php
global $product;
if (get_field('longitude') && get_field('latitude') && get_field('zoom') && get_field('adresse_map')) :
    ...
    <div class="container-narrow">
        ...
        <ul class="attributs">
            <?php if (have_rows('attributs')) : ?>
                ...
                ?>
                    <li>
                        <img src="<?= esc_url($attribut_img['url']); ?>" alt="<?= esc_attr($attribut_img['alt']); ?>">
            ...
            <li class="intervenant-mini">
                ...
                if (get_field('image_intervenant')) :
                    ...
                    <img src="<?= esc_url($image_intervenant['url']); ?>" alt="<?= esc_attr($image_intervenant['alt']); ?>">
        ...
        <div class="bonhomme">
            ...
            <img src="<?= get_stylesheet_directory_uri(); ?>/assets/fleche.svg" alt="Flèche pointant vers le haut">
        </div>
    </div>
</section>
    ...
    <div class="product-container-narrow">
        <section class="product-content">
            <?php if (have_rows('partager_le_voyage')) : ?>
                <div class="share">
                    <strong>Vos sens en éveil : </strong>
                        ...
                        ?>
                            <li>
                                <a href="<?= esc_url($share_link['url']); ?>">
                                    <img src="<?= esc_url($share_image['url']); ?>" alt="<?= esc_attr($share_image['alt']); ?>">
                                </a>
                            </li>
                        <?php endwhile; ?>
                    </ul>
                                ...
                                <ul>
                                    <?php while (have_rows('passions')) : the_row(); ?>
                                        <li>
                                            ...
                                            <img src="<?= esc_url($passion_image['url']); ?>" alt="<?= esc_attr($passion_image['alt']); ?>">
        ...
        <?php if (get_field('adresse')) : ?>
            <section class="infos-pratique">
                ...
                <div class="infos-pratique__content">
                    <aside class="where">
                        <img src="<?= get_stylesheet_directory_uri(); ?>/assets/pin-black.svg" alt="Pin de géolocalisation">
                        <div class="texte">
                            <p>Où</p>
                    ...
                    <aside class="time">
                        <img src="<?= get_stylesheet_directory_uri(); ?>/assets/point-to-point.svg" alt="Point à point">
                        <div class="texte">
                        ...
                        <ul>
                            <?php while (have_rows('sy_rendre')) : the_row(); ?>
                                <li>
                                    ...
                                    <img src="<?= esc_url($image_rendre['url']) ?>" alt="<?= esc_attr($image_rendre['alt']);
                                                                                            ?>">
                                    <p><?php the_sub_field('texte'); ?></p>
                                </li>
                            <?php endwhile; ?>
...
<template v-if="showNotification && currentCart.length > 0">
    <section class="cart-confirmation">
        <div class="cart-confirmation__wrapper">
            <img src="<?= get_template_directory_uri() ?>/assets/close.svg" alt="Fermer la fenêtre" class="close__pop-up" @click="closeShowNotification">
...
<script>
    ...
    createApp({
        ...
        async mounted() {
            ...
            this.marker = L.marker([this.longitude, this.latitude], {
