...
<main class="private" id="root">
    ...
    <section class="choose">
        <div class="container-narrow">
            ...
            <div :class="particulier && !entreprise ? 'particulier active' : 'particulier'">
            ...
            <div :class="!particulier && entreprise ? 'particulier entreprise active' : 'particulier entreprise'">
                <div class="particulier__container">
	...
	<?php if ( have_rows( 'ils_parlent_de_nous' ) ) :
        ...
        <section class="reviews" v-if="particulier || entreprise">
            <div class="container-narrow">
                <h2 class="title__reviews">Ils nous font confiance :</h2>
	...
	<template v-if="errorServer">
		<section class="response-form">
			<div class="container-center">
				<h2 class="terracota">Une erreur s'est produite de notre côté</h2>
	...
	<template v-if="error">
		<section class="response-form">
			<div class="container-center">
				<h2 class="terracota">Une erreur s'est produite!</h2>
				<strong>Un champ est peut-être manquant ou invalide, vous devriez vérifier le formulaire pour plus
            ...
            methods: {
                ...
                isSent () {
                    ...
                    if( formUrl.hash ) {
                        ...
                        if ( responseOutput == "Merci pour votre message. Il a été envoyé." ) {
                            this.sent = true;
                        } else if ( responseOutput == "Un ou plusieurs champs contiennent une erreur. " +
