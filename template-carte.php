            ...
            methods: {
                ...
                setMapPoints() {
                    this.products.forEach(product => {
                        ...
                        marker.bindPopup(`<div class="marker-map"><div class="upper"><img src="${src}" alt="" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" /><div class="right-marker"><div class="fanion-container"><div
