...
<main class="blog" id="app">
    ...
    <article>
        <div class="container-narrow">
            ...
            <div v-if="loaded" class="categories" id="card-container">
                <ul>
...
<script>
    ...
    createApp( {
        ...
        async mounted () {
            ...
            await axios.get( `${this.siteUrl}/wp-json/better-rest-endpoints/v1/posts?per_page=50` ).then( res => {
                this.posts = res.data
            } )
        ...
        methods: {
            ...
            async handleClickNext () {
                ...
                let pos = cardContainer.offsetTop;
                window.scrollTo({
                    top: pos,
                    behavior: 'smooth'
                });
            ...
            async changePage ( pageNumber ) {
                await this.handlePageChange( pageNumber )
                const cardContainer = document.getElementById('card-container' );
                let pos = cardContainer.offsetTop;
                window.scrollTo({
                    top: pos,
